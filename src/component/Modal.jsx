          ...
          <Form>
            <div className="d-flex">
              <div className="addvalue-dashboard-left d-flex flex-column">
                ...
                {errors.productPlace && touched.productPlace ? <div>{errors.productPlace}</div> : null}

                <label htmlFor="firstName">Hạn sử dung sản phẩm</label>
                <Field name="productExp" type="productExp" />
                {errors.productExp && touched.productExp ? <div>{errors.productExp}</div> : null}

                <label htmlFor="firstName">Lựa chọn công dụng</label>
                <Field name="productUse" type="productUse" />
                {errors.productUse && touched.productUse ? <div>{errors.productUse}</div> : null}
                <label htmlFor="firstName">Lựa chọn công dụng</label>
            ...
            <div className="addvalue-dashboard-middle">
              ...
              <Field id="productDescription" name="productDescription" placeholder="Doe" />
              {errors.productDescription && touched.productDescription ? <div>{errors.productDescription}</div> : null}</div>
